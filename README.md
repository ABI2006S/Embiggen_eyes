...
│   │   └── analyze-image.ts      # AI analysis server logic
...
│   │   └── ...
│   │
│   ├── ai-analysis.tsx           # AI analysis panel with summary
│   ├── aurora-background.tsx     # Animated canvas background
│   ├── hero-section.tsx          # Landing page hero with music
│   ├── image-viewer.tsx          # NASA image viewer with zoom
│   ├── image-detail-viewer.tsx   # Detailed image information
│   ├── navigation.tsx            # Top navigation bar
│   ├── outro-section.tsx         # Footer with team & GitHub
│   ├── planet-3d.tsx             # 3D planet renderer with Saturn rings
│   ├── planet-section.tsx        # Individual planet section
│   ├── planet-sections.tsx       # All planets container
│   ├── research-panel.tsx        # Celestial research database
│   └── search-bar.tsx            # NASA search with filters
│
├── lib/                          # Utility functions & config
│   ├── annotations.ts            # Firestore annotation CRUD
...
│   │   └── team/                 # Team assets
│   │       └── team-logo.png
│   ├── sun-texture.jpg           # Planet textures
│   ├── mercury-texture.jpg
│   ├── venus-texture.jpg
│   ├── earth-texture.jpg
│   ├── mars-texture.jpg
